...
assert_contains "$WORKDIR/layer-source.out" "HAOS_BUILDER_IMAGE_DIGEST="
assert_contains "$WORKDIR/layer-source.out" "GITHUB_RUN_ID="
assert_contains "$WORKDIR/layer-source.out" "RUNNER_IMAGE_VERSION="
...
assert_contains "$WORKDIR/diagnostics.out" "HAOS_BUILDER_IMAGE_DIGEST="
